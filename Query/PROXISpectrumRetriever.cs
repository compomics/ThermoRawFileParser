...
{
    public class ProxiSpectrumRetriever 
    {
        ...
        public ProxiSpectrumRetriever(QueryParameters _queryParameters)
        {
            this.queryParameters = _queryParameters;
        }

        /// <inheritdoc />       
        public List<PROXISpectrum> Retrieve(IRawDataPlus rawFile, HashSet<int> scanSet)
        {
